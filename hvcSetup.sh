...
# Set up the heavyCoin mining files 	
...
# Get the user wallet address
	...
	echo "HeavyCoin now mining. See your progress with this command:\ncat ~/cpuminer-heavycoin/nohup.out | grep -ie yay"