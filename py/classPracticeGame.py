...
class Scene(object):
    ...
    def enter(self):
        print "This is a class, from which other classes get their " \
...
class Robbed(Scene):
    ...
    def enter(self):
        ...
        print "Every scumbag in the city was out robbing people who " \
              "were as dumb as you"
...
class Street(Scene):
    ...
    def enter(self):
        ...
        if hello == "hello":
            ...
            print "dogs even runs over to play with you, you eventually" \
                  " go in your door"
            return 'beer'
...
class Hospital(Scene):
    ...
    def enter(self):
        print "Well done, you ended up in hospital! One of the dodgy " \
              "looking guys was very nice and brought you in"
        print "Your ankle is broken, and you will be on crutches"
        print "Now you have no money, can't walk and are down to the " \
              "final option"
        ...
        if hospital == "mam":
            ...
            print "and I never took a sick day in my life. I'll be there in " \
                  "20 minute."
...
class Pyjames(Scene):
    def enter(self):
        ...
        excall = raw_input("You know your ex will save you, but .... do you make the call\n> 'yes' or 'no'").lower()
